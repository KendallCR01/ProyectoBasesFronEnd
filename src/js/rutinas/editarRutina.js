...
export const editarRutina = async (courseData) => {
    try {
        const response = await fetch('http://localhost:3000/actualizar-rutina', {
        ...
        if (response.ok) {
            ...
            console.log('Rutina editada con éxito:', data.message);
